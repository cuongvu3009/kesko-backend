...
exports.ServerError = exports.FileTooLargeError = exports.NotAuthorized = exports.NoFoundError = exports.BadRequestError = exports.JoiRequestValidationError = exports.CustomError = void 0;
...
class NoFoundError extends CustomError {
    constructor(message) {
        super(message);
...
exports.NoFoundError = NoFoundError;
